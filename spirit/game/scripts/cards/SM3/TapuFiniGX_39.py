...
card = PokemonCardDef(
    guid='e31cd883-f5f0-5026-858b-6d1dd90e5f26',
    key='SM3',
    ...
    abilities=[
        ...
        Attack(
            title='Hydro Shot',
            game_text="Discard 2 Water Energy from this Pokémon. This attack does 120 damage to 1 of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)",
