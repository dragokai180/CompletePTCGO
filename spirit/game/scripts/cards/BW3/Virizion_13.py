...
card = PokemonCardDef(
    guid="7b5a3998-470d-5c32-9376-dd13dd19a56f",
    key="BW3",
    ...
    abilities=[
        ...
        Attack(
            title="Leaf Wallop",
            game_text="During your next turn, this Pokémon's Leaf Wallop attack does 40 more damage (before applying Weakness and Resistance).",
