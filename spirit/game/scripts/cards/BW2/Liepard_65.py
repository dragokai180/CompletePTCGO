...
card = PokemonCardDef(
    guid="bd1f34cf-6e54-5934-9d3f-99b538a869d9",
    key="BW2",
    ...
    abilities=[
        Attack(
            title="Feint Attack",
            game_text="Does 30 damage to 1 of your opponent's Pokémon. This attack's damage isn't affected by Weakness, Resistance, or any other effects on that Pokémon.",
