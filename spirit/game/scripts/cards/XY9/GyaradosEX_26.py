...
card = PokemonCardDef(
    guid='60a9782b-e079-599c-9cbf-44349ad35785',
    key='XY9',
    ...
    abilities=[
        Attack(
            title='Stormy Seas',
            game_text='Flip a coin until you get tails. For each heads, search your deck for a Water Energy card and attach it to this Pokémon. Shuffle your deck afterward.',
