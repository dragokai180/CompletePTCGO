...
card = PokemonCardDef(
    guid='66a034f9-f92f-5d26-a2e3-3b3de675ae94',
    key='SM1',
    ...
    abilities=[
        ...
        Attack(
            title='Psychic',
            game_text="This attack does 30 more damage times the number of Energy attached to your opponent's Active Pokémon.",
