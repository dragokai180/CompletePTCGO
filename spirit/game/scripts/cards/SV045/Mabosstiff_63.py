...
card = PokemonCardDef(
    guid='7cc9c3d1-2fdd-55ba-8087-713affc16512',
    key='SV045',
    ...
    abilities=[
        Ability(
            ...
            game_text="Once during your turn, you may switch out your opponent's Active Pokémon to the Bench. (Your opponent chooses the new Active Pokémon.)",
